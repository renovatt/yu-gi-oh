export const getAllCards = async (quantity: number) => {
    try {
        const response = await fetch(`https://db.ygoprodeck.com/api/v7/cardinfo.php?&language=pt&num=${quantity}&offset=0`)
